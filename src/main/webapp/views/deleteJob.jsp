...
<c:when test="${jobId>0}">
       <div class="container mb-0">
               ...
               <hr><br>
                <div class="col-md-4 " style="margin-left:900px;">
                  <form onsubmit="return show_alert(${numCandidates});" action="deleteJob/${jobId}" method="post">
...
function show_alert(message) {
  if(!confirm("There are " + message + " candidates registered for this post,do you stil want to do it?")) {
    return false;
  }
  this.form.submit();
}
</script>
<div class="col-md-2 mt-4 " style="margin-left:900px;">
