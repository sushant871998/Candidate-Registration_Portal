...
<head>
    ...
    <link rel="stylesheet" href="../css/notEligible.css" type="text/css">
</head>
<body>
<div class="container">
...
<div class="text">
  <div class="text-inner">
    ...
    <h2> It seems that the you do not meet the requirements to apply for this post,please try gain sometine later.</h2>
